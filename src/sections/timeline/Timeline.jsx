...
export default function Timeline() {
  ...
  return (
    <section className={styles.timelineParent}>
        <h1 className={styles.heading}>From Hello World to the World</h1>
